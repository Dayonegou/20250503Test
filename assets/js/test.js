...
//分割代入で、クラスplayerとstringToDataUrlをライブラリから取ってくる

// TextAlive Player を初期化
const player = new Player({ //取ってきたクラスをもとに、インスタンスを作成
  // トークンは https://developer.textalive.jp/profile で取得したものを使う
  app: { token: "KJZe6vtNVyd2EZsl" }, 
  //←appオブジェクト（情報がまとまっている）TextAliveのPlayerがこうやって書くように要求している
...
console.log("DOMから必要な要素をそれぞれ取って変数へin")
